...
def cmr_download(urls, obj, force=False, quiet=False):
...
class SMAPDownload():
    ...
    def __init__(self, short_name='SPL3SMP_E', version='005',
        ...
        self.time_end = '{}T00:00:00Z'.format(time_end) 
    ...
    def query(self):
        ...
        url_list = [x for x in url_list if x.endswith('.h5')]
        self.url_list = url_list
        return url_list
