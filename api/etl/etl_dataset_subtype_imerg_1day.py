...
class ETL_Dataset_Subtype_IMERG_1DAY(ETL_Dataset_Subtype_Interface):
    ...
    def __init__(self, etl_parent_pipeline_instance=None, dataset_subtype=None):
        ...
        if dataset_subtype == 'imerg_1dy_early':
            self.mode = 'EARLY'
        elif dataset_subtype == 'imerg_1dy_late':
            self.mode = 'LATE'
        else:
            self.mode = 'LATE'
        ...
        try:
            ...
            for expected_granules_object in self._expected_granules:
                try:
                    ...
                    ds.precipitation_amount.attrs = OrderedDict([('long_name', 'precipitation_amount'), ('units', 'mm'), ('accumulation_interval', '1 day'), ('comment', comment)])
