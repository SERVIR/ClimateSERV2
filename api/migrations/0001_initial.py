# Generated by Django 3.2.6 on 2022-01-19 19:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('etl', models.CharField(choices=[], default='CHIRPS', max_length=60)),
                ('start_year', models.CharField(default='2020', max_length=4)),
                ('end_year', models.CharField(default='2020', max_length=4)),
                ('start_month', models.CharField(default='1', max_length=2)),
                ('end_month', models.CharField(default='12', max_length=2)),
                ...
                ('merge_option', models.CharField(choices=[('no_merge', 'No Merge'), ('monthly', 'Monthly'), ('yearly', 'Yearly')], default='never', max_length=10)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_request', models.BooleanField(default=False, help_text='Is this a request for metadata instead of actual data (eg., information about what data is available)?', null=True)),
            ],
            options={
