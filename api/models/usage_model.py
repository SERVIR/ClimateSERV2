...
class Track_Usage(models.Model):
    ...
    AOI = models.JSONField(default=None, null=True)
    dataset = models.CharField(max_length=50, null=True, default=None)
    ...
    API_call = models.CharField(max_length=250, null=True, blank=True, default=None)
