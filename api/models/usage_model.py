...
class Track_Usage(models.Model):
    ...
    country_ISO = model.CharField(help_text='ISO Country Code for originating IP', max_length=2, null=True)
    metadata_request = model.BooleanField(help_text="Is this a request for metadata instead of actual data (eg., information about what data is available)?", default=False, null=True)
