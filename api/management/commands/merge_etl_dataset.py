    ...
    def handle(self, *args, **options):
        ...
        if MONTH_MM:
            if etl_dataset.dataset_subtype == 'chirp':
                ...
                pass
            pattern_filepath = os.path.join(pattern_filepath, pattern_filename.format(MONTH_MM, YEAR_YYYY))
            temp_aggregate_filepath = os.path.join(temp_aggregate_filepath, 'by_month/', aggregate_filename.format(MONTH_MM, YEAR_YYYY))
        else:
