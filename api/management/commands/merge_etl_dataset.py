    ...
    def handle(self, *args, **options):
        ...
        if MONTH_MM:
            if etl_dataset.dataset_subtype == 'chirp':
                temp_fast_path = os.join('temp_fast_path', 'fast_chirp')
            ...
            if etl_dataset.dataset_subtype == 'chirps':
                temp_fast_path = os.join('temp_fast_path', 'fast_chirps')
                ...
                temp_fast_path = os.join('temp_fast_path', 'fast_sport_esi_12wk')
                ...
                temp_fast_path = os.join('temp_fast_path', 'fast_sport_esi_4wk')
                pattern_filename = 'sport-esi.{}*.nc4'
                aggregate_filename = 'sport-esi.global.0.05deg.4wk.{}.nc4'
                ncrcat_options = '-4 -h -L 1 --cnk_dmn time,31 --cnk_dmn longitude,256 --cnk_dmn latitude,256'
            elif etl_dataset.dataset_subtype == 'imerg_early_1dy':
                temp_fast_path = os.join('temp_fast_path', 'nasa_imerg_early_daily')
                ...
                temp_fast_path = os.join('temp_fast_path', 'nasa_imerg_lat_daily')
                ...
                temp_fast_path = os.join('temp_fast_path', 'fast_usda_smap')
